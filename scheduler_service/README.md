...
5. View API Documentation:
    Swagger UI: Open a web browser and go to http://127.0.0.1:8000/docs to access the interactive API documentation provided by FastAPI's Swagger UI.
    ReDoc: Open a web browser and go to http://127.0.0.1:8000/redoc for an alternative view of the API documentation.
